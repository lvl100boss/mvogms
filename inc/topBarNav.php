...
<!-- Navbar -->
<nav class="w-100 px-2 py-1 position-fixed top-0 text-light" id="login-nav">
...
<nav class="main-header navbar navbar-expand-md navbar-light border-0 text-sm shadow" id='top-Nav'>
  <div class="container">
    ...
    <div class="collapse navbar-collapse order-3 bg-" id="navbarCollapse">
      <!-- Left navbar links -->
      <ul class="navbar-nav">
        <li class="nav-item">

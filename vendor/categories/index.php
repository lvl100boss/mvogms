...
<?php endif; ?>
<div class="card card-outline card-primary" style="background-color: #1e1e1e; color: #ffffff;">
	<div class="card-header" style="background-color: #14453d;">
		...
		<div class="container-fluid">
			<div class="container-fluid">
				<table class="table table-bordered table-stripped" style="color: #ffffff;">
					...
					<thead>
						<tr class="bg-gradient-secondary" style="background-color: #14453d;"></tr>
						<th>#</th>
						<th>Date Created</th>
						<th>Name</th>
						<th>Description</th>
						...
						?>
							<tr>
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu" style="background-color: #1e1e1e; color: #ffffff;">
										<a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" style="color: #ffffff;"><span class="fa fa-eye text-dark"></span> View</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item edit_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" style="color: #ffffff;"><span class="fa fa-edit text-primary"></span> Edit</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" style="color: #ffffff;"><span class="fa fa-trash text-danger"></span> Delete</a>
									</div>
								</td>
							</tr>
						<?php endwhile; ?>

...
<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-light text-sm shadow bg-black">
  <!-- Left navbar links -->
  <ul class="navbar-nav">
    <li class="nav-item">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="<?php echo base_url ?>" class="nav-link text-white"><?php echo (!isMobileDevice()) ? $_settings->info('name') : $_settings->info('short_name'); ?> - Vendor Side</a>
    </li>
  </ul>
  <!-- Right navbar links -->

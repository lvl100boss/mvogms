...
<div class="content py-3 bg-black overflow-hidden" style="background-color: black; color: #ffffff;">
    <div class="card card-outline shadow rounded-0" style="border-color: #14453d;">
        <div class="card-header" style="background-color: #14453d; color: #ffffff;">
            <h5 class="card-title">Monthly Order Reports</h5>
        </div>
        <div class="card-body bg-black">
            <div class="container-fluid">
                <div class="callout callout-primary shadow rounded-0 border-0 m-0 bg-black" style="background-color: black; color: #ffffff;">
                    <form action="" id="filter">
                        <div class="row align-items-end">
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label for="month" class="control-label">Month</label>
                                    <input type="month" name="month" id="month" value="<?= $month ?>" class="form-control rounded-0" required style="background-color: #333333; color: #ffffff; border-color: #14453d;">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                <div class="form-group">
                                    <button class="btn btn-flat btn-sm" style="background-color: #14453d; color: #ffffff;"><i class="fa fa-filter"></i> Filter</button>
                                    <button class="btn btn-light border btn-flat btn-sm" type="button" id="print" style="background-color: #333333; color: #ffffff; border-color: #14453d;"><i class="fa fa-print"></i> Print</button>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <div id="outprint">
                        <table class="table table-bordered table-stripped" style="color: #ffffff;">
                            <colgroup>
                                <col width="5%">
                                <col width="15%">
                                <col width="20%">
                            ...
                            <thead style="background-color: #14453d;">
                                <tr>
                            ...
                            <tfoot style="background-color: #14453d;">
                                <tr>
